...
void loop()
{
  ...
  { 
    ...
    {
      Serial.println("VDown");                // send "next" serially.
    }
  }
  ...
  { 
    ...
    {
    Serial.println("Play/Pause");            // send "previous" serially.
